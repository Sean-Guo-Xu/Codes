...
pbmc <- subset(x = pbmc, subset = nFeature_RNA > 200& nFeature_RNA <5500 & percent.mt < 25 & percent_hb<5)
...
DimPlot(pbmc,label = T,group.by = "DF.classifications_0.25_0.3_4347")
pbmc = subset(pbmc,DF.classifications_0.25_0.3_4347 == "Singlet" )
DimPlot(pbmc,label = T,group.by = "DF.classifications_0.25_0.3_4347")
...
Myeloid = c("CD14","CD68","LYZ") #2 5 8 9 19 22
B = c("CD79A","MZB1","MS4A1") #1 6 11 18 20 21 27
Proliferation = c("MKI67","TOP2A","CDC20") #15
#14 unsure
markers = c(T,B,NK,Mast,Endothelial,Fibroblast,SMC,Myeloid,Proliferation)
############ÊÖ¶¯×¢ÊÍ#########

DotPlot(pbmc,features = markers)
pbmc$cell[pbmc$seurat_clusters %in% c(7)] = "NK cell"
pbmc$cell[pbmc$seurat_clusters %in% c(0,17,26)] = "T cell"
pbmc$cell[pbmc$seurat_clusters %in% c(16)] = "Mast cell"
pbmc$cell[pbmc$seurat_clusters %in% c(24,23,3)] = "Endothelial"
pbmc$cell[pbmc$seurat_clusters %in% c(12,10,13)] = "Fibroblast"
pbmc$cell[pbmc$seurat_clusters %in% c(4,25)] = "SMC"
pbmc$cell[pbmc$seurat_clusters %in% c(2,5,8,9,19,22)]="Myeloid"
pbmc$cell[pbmc$seurat_clusters %in% c(1,6,11,18,20,21,27)] = "B cell"
pbmc$cell[pbmc$seurat_clusters %in% c(15)] = "Proliferation"
pbmc$cell[pbmc$seurat_clusters %in% c(14)] = "Unsure"
