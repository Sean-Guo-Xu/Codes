...
small=classify[which(classify$V7 %in% target1 ),]
cutphy=small[1,3]
class = read.table("D:\\bigslice\\bgc_information.txt",sep="\t",header=F,fill=T)
name=class[which(class$V6 %in% cutphy),10]
...
tiff("D:\\bigslice\\Aspergillus&Fusarium&others.tiff",width = 3000,height = 3000,units = "px")
